...
public class CustomSelectInput extends RelativeLayout {
    ...
    public void setTextName(String textName) {
        if (!StringUtils.isEmpty(textName)) {
            ...
            tv.setTextColor(getResources().getColor(R.color.theme_back));
    ...
    public void setDefaultText(String textName) {
        if (!StringUtils.isEmpty(textName)){
            this.tv.setText(textName);
            tv.setTextColor(getResources().getColor(R.color.theme_text));
        }
    }
    ...
    public void showDialog() {
        ...
        if (onSelectData != null) {
            ...
            titleView.setTextColor(getResources().getColor(R.color.theme_back));
        }
